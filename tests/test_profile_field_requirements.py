...
class ProfileFieldRequirementsTests(unittest.TestCase):
    ...
    def test_academic_info_gpa_and_expected_graduation_year_required_institution_optional(self):
        ...
        self.assertTrue(any(err["loc"] == ("expected_graduation_year",) for err in ctx.exception.errors()))
