...
class EmailVerificationFlowTests(unittest.TestCase):
    ...
    def setUp(self):
        LanguageDetail.__table__.drop(self.engine, checkfirst=True)
        WorkExperience.__table__.drop(self.engine, checkfirst=True)
        ...
        WorkExperience.__table__.create(self.engine)
        LanguageDetail.__table__.create(self.engine)
